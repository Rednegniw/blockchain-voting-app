...
app.get('/queryAll', (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const networkObj = yield network.connectToNetwork(appAdmin);
    if ((0, types_1.isNetworkObj)(networkObj)) {
        const response = yield network.invoke(networkObj, true, 'queryAll', ['']);
        const parsedResponse = yield JSON.parse(response.toString('utf8'));
...
app.get('/getCurrentStanding', (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const networkObj = yield network.connectToNetwork(appAdmin);
    if ((0, types_1.isNetworkObj)(networkObj)) {
        const response = yield network.invoke(networkObj, true, 'queryByObjectType', ['votableItem']);
        const parsedResponse = yield JSON.parse(response.toString('utf8'));
        res.send(parsedResponse);
    }
    else {
...
app.post('/castBallot', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const networkObj = yield network.connectToNetwork(req.body.voterId);
    if ((0, types_1.isNetworkObj)(networkObj)) {
...
app.post('/queryWithQueryString', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const networkObj = yield network.connectToNetwork(appAdmin);
    if ((0, types_1.isNetworkObj)(networkObj)) {
        const response = yield network.invoke(networkObj, true, 'queryByObjectType', [req.body.selected]);
        const parsedResponse = yield JSON.parse(response.toString('utf8'));
        res.send(parsedResponse);
    }
    else {
...
app.post('/queryByKey', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('req.body: ');
    console.log(req.body);
    let networkObj = yield network.connectToNetwork(appAdmin);
    console.log('after network OBj');
    if ((0, types_1.isErrorObj)(networkObj)) {
        res.status(500).send(networkObj);
        return;
    }
    let response = yield network.invoke(networkObj, true, 'readMyAsset', [req.body.key]);
